...
<span style= "display: inline-block; margin: 10px;"><b>Retinue Options: </b> Orc Warriors, Orc Brutes, Boar Riders, Orc Chariot, Wyvern</span>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinShaman.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">Infantry</span>
</div>


<div class = "unit-name">Goblin Shaman</div>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinKing.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">Infantry Large</span>
</div>


<div class = "unit-name">Goblin King</div>
...
<img src = "images/GreenskinTribes/GoblinKing.png" style="position:absolute; bottom:70px; right:0px; height:320px">
<div class = "unit-details">
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/Wyvern.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinSpearMob.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">Infantry</span>
</div>


<div class = "unit-name">Goblin Spear Mob</div>

</div>


<div class = "propsContainer">
<div class = "unit-props" > <div class="tooltip">Spear and Shield<span class="tooltiptext">+1 Defense. Extra Rank supporting attacks when not charging.</span></div>, Magic Banner (up to 50pts) </div>
</div>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/OrcBoarChariot.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">Chariot</span>
</div>


<div class = "unit-name">Orc Boar Chariot</div>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinShortbows.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">Infantry</span>
</div>


<div class = "unit-name">Goblin Shortbows</div>

</div>


<div class = "propsContainer">
<div class = "unit-props" > <div class="tooltip">Shortbows<span class="tooltiptext">Range: 20. Power 3.</span></div>, Magic Banner (up to 50pts) </div>
</div>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinBoltThrowers.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">War Machine</span>
</div>


<div class = "unit-name">Goblin Bolt Throwers</div>
...
<div class="tooltip">
<img src = "icons/GreenskinTribes/GoblinStonethrower.png" style = " height:52px; margin-top: 4px; margin-left: 4px">
 <span class="tooltiptext">War Machine</span>
</div>


<div class = "unit-name">Goblin Stonethrower</div>
...
<img src = "images/GreenskinTribes/GoblinStonethrower.png" style="position:absolute; bottom:70px; right:0px; height:320px">
<div class = "unit-details">
...
<div class = "propsContainer">
<div class = "unit-props" > <div class="tooltip">Hand Weapon<span class="tooltiptext">Charge Bonus: +1 Power</span></div>, <div class="tooltip">Fearless<span class="tooltiptext">Ignores all penalties to Discipline tests.</span></div> </div>
</div>
